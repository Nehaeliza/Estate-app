...
app_publisher = "Neha Joy"
app_description = "An app for real estate"
app_email = "neha@site.com"
app_license = "mit"
# required_apps = []
...
'''scheduler_events = {
    "all":
           ...
           [ "estate_app.test.send_weekly_holiday_emails"]
...
# doc_events = {
#     "Teacher": {
#         "on_update": "estate_app.api.teacher_api.on_update_teacher"
...
# # in estate_app/estate_app/hooks.py

# override_whitelisted_methods = {
#     "estate_app.api.teacher_api.create_teacher": "estate_app.api.teacher_api.create_teacher",
#     "estate_app.api.teacher_api.get_teacher": "estate_app.api.teacher_api.get_teacher",
#     "estate_app.api.teacher_api.update_teacher": "estate_app.api.teacher_api.update_teacher",
#     "estate_app.api.teacher_api.delete_teacher": "estate_app.api.teacher_api.delete_teacher"
# }
